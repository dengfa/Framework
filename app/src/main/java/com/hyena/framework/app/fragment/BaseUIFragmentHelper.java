...
import com.hyena.framework.servcie.event.EventChainService;
...
public class BaseUIFragmentHelper {
    ...
    public void onCreateView() {
        EventChainService service = getService(EventChainService.SERVICE_NAME);
        if (service != null && mBaseUIFragment != null) {
            service.startNextEvent(mBaseUIFragment.getClass().getName());
        }
    }
