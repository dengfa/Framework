...
public class CommonTitleBar extends TitleBar {
	...
	protected void initBackBtn(){
		...
		//textView mode
		RelativeLayout.LayoutParams backTxtParams = new RelativeLayout.LayoutParams(
     ...
     * 右侧点击动作
     */
    public void setMenuMoreTxt(final String txt, final View.OnClickListener clickListener) {
    	UiThreadHandler.post(new Runnable() {
            @Override
            public void run() {
                setVisibility(View.VISIBLE);
     ...
     * 右侧点击动作
     */
    public void setMenuMoreImage(final int resId, final View.OnClickListener clickListener) {
    	UiThreadHandler.post(new Runnable() {
            @Override
            public void run() {
                setVisibility(View.VISIBLE);
